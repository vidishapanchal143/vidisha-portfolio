...
function initVideoModal() {
    ...
    const openBtns = document.querySelectorAll('.open-modal, .play-btn, .modal-trigger');
        ...
        if (type === 'video' && videoSrc) {
            ...
            if (modalVideo) {
                ...
                modalVideo.play().catch(e => {
                    console.warn('Autoplay with sound prevented, showing tap to play:', e);
                    // Add standard controls so the user can easily tap play/unmute
                });
            }
